...
public class CrearTablas {
    ...
    public static void crearTablasEnBD(){
        ...
        String crearTablaProductos = "CREATE TABLE IF NOT EXISTS Productos(producto_id INT auto_increment PRIMARY KEY, nombre VARCHAR(100) NOT NULL, descripcion VARCHAR(100) NOT NULL, precio DECIMAL(10, 2) NOT NULL, proveedor_id INT NOT NULL, FOREIGN KEY(proveedor_id) REFERENCES Proveedores(proveedor_id));";
        String crearTablaVentas = "CREATE TABLE IF NOT EXISTS Ventas(venta_id INT auto_increment PRIMARY KEY, cliente_id INT NOT NULL, producto_id INT NOT NULL, fecha DATE NOT NULL, monto_total DECIMAL(10, 2) NOT NULL, FOREIGN KEY(cliente_id) REFERENCES Clientes(cliente_id), FOREIGN KEY(producto_id) REFERENCES Productos(producto_id));";
